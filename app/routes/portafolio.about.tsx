    ...
    <main>
      <div className="about-content">
        <div className="about-content-text">
          ...
          <div className="about-container">
            <div>
              ...
              <p>
                ...
                que sean eficaces, accesibles y afable. Con atención, esfuerzo y
                perseverancia.
              </p>
            </div>
          ...
          <h6>EXPERIENCIA</h6>
          <p>
            Me estoy enfocando en aprender nuevas tecnoloías, actualmente Remix
            es una de ellas, éste Portafolio esta desarrollado en Remix-tsx.
          </p>
          ...
          <p>
            ...
            habilidades tanto responsabilidad para un crecimiento propio, con
            una curva de aprendizaje corta.
          </p>
          <h3>APTITUDES</h3>
          <p>
            Siendo autodidacta, responsable con dedicación para trabajar en
            equipo de manera organizada, cumpliendo con cada fragmento referente
            al trabajo; realizando tareas de manera efectiva en tiempo y forma.
          </p>
        </div>
      </div>
    </main>
